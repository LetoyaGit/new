    ...
    <div className='border-t pt-14'>
      ...
      <div>
        ...
        cartData.map((item, index) => {
          ...
          if (!productData) return null; // Handle undefined product data gracefully
          ...
          return (
            <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
              ...
              <img onClick={()->updateQuantity(item.id,-)} className='w-4 mr-4 sm:w-5 cursor-pointer' src={assets.bin_icon} alt=''/>
            </div>
          )
        })
}
